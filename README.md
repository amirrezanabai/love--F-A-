...
<head>
  <meta charset="UTF-8">
  <title>صفحه‌ی عاشقانه امیررضا</title>
  <style>
    body {
      margin: 0;
      padding: 0;
      font-family: 'Vazir', sans-serif;
      background: linear-gradient(135deg, #fff1f7, #ffe3ec);
      color: #b8004b;
      overflow: hidden;
      height: 100vh;
      text-align: center;
